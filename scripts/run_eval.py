...
def main():
    ...
    baseline_gp = sum(r["grounded_precision"] for r in baseline_results) / len(baseline_results)
    react_gp = sum(r["grounded_precision"] for r in react_results) / len(react_results)
